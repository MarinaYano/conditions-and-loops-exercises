...
} else if(weapon === "a trophy" && room === "gallery" && suspect === "Ms. Van Cleve") {
} else if(weapon === "a pool stick" && room === "billiards room" && suspect === "Mrs. Sparr") {
} else if(weapon === "a knife" && room === "dining room" && suspect === "Mr.Parkes"){
}
